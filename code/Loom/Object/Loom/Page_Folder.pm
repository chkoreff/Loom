package Loom::Object::Loom::Page_Folder;
use strict;
use Loom::Context;
use Loom::Dttm;
use Loom::Object::Loom::EZ_Archive;
use Loom::Object::Loom::EZ_Grid;
use Loom::Qty;
use Loom::Quote::Span;
...
sub new
	...
	$s->{module} =
		{
		folder => "Loom::Object::Loom::Page_Wallet",
		contact => "Loom::Object::Loom::Page_Contact",
		asset => "Loom::Object::Loom::Page_Asset",
		};
...
sub page_login
	...
	if ($op->get("help"))
		{
		# LATER get rid
		$site->object("Loom::Object::Loom::Page_Help",$site,"index")->respond;
		return;
		}
