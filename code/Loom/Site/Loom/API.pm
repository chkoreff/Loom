package Loom::Site::Loom::API;
use strict;
use Loom::Context;
use Loom::DB::Prefix;
use Loom::Site::Loom::API_Archive;
use Loom::Site::Loom::API_Grid;
...
sub new
	...
	my $grid = Loom::Site::Loom::API_Grid->new($grid_space);

	my $archive_space = Loom::DB::Prefix->new($s->{db},"ar_");
	my $archive = Loom::Site::Loom::API_Archive->new($archive_space,$grid);
