package Loom::Object::Loom::Page_Tool;
use strict;
...
<td>Identifier:</td>
<td>
<input type=text class=tt name=id size=$input_size_id value="$q_id">
...
<td>Passphrase:</td>
<td>
<input type=text name=passphrase size=50 value="$q_passphrase">
